...
const TrainingProgram = () => {
  ...
  const fetchProgram = async (programId) => {
    try {
      const url = userId
        ? `http://16.171.79.44/api/training-program/${programId}/?__user_id=${userId}`
        : `http://16.171.79.44/api/training-program/${programId}/`;
  ...
  const fetchLatestProgram = async () => {
    try {
      const url = userId
        ? `http://16.171.79.44/api/training-program/latest/?__user_id=${userId}`
        : `http://16.171.79.44/api/training-program/latest/`;
  ...
  const createNewProgram = async () => {
    try {
      const url = userId
        ? `http://16.171.79.44/api/training-program/?__user_id=${userId}`
        : `http://16.171.79.44/api/training-program/`;
  ...
  const addWeek = async () => {
    try {
      const url = userId
        ? `http://16.171.79.44/api/training-program/${currentProgram}/add-week/?__user_id=${userId}`
        : `http://16.171.79.44/api/training-program/${currentProgram}/add-week/`;
