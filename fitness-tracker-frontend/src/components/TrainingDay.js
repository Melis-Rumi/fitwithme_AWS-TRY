...
const TrainingDay = () => {
  ...
  const fetchExercises = async () => {
    try {
      const url = userId
        ? `https://fitwithmpt.pythonanywhere.com/api/training-day/${dayId}/?__user_id=${userId}`
        : `https://fitwithmpt.pythonanywhere.com/api/training-day/${dayId}/`;
  ...
  const handleDeleteExercise = async (exerciseId) => {
    try {
      const url2 = userId
        ? `https://fitwithmpt.pythonanywhere.com/api/exercise/${exerciseId}/?__user_id=${userId}`
        : `https://fitwithmpt.pythonanywhere.com/api/exercise/${exerciseId}/`;
