...
const TrainingDay = () => {
  ...
  const fetchExercises = async () => {
    try {
      const url = userId
        ? `https://16.171.79.44/api/training-day/${dayId}/?__user_id=${userId}`
        : `https://16.171.79.44/api/training-day/${dayId}/`;
  ...
  const handleDeleteExercise = async (exerciseId) => {
    try {
      const url2 = userId
        ? `https://16.171.79.44/api/exercise/${exerciseId}/?__user_id=${userId}`
        : `https://16.171.79.44/api/exercise/${exerciseId}/`;
